...
przycinanie (Pruning). Kwantyzacja polega na redukcji zapisu precyzji wag, co redukuje rozmiar modelu i przyspiesza obliczenia kosztem niewielkiej utraty dokładności.
Przycinanie zaś jest techniką optymalizacji polegającą na usuwaniu zbędnych parametrów bez istotnej utraty dokładności \cite{tflite_quantization_krishnamoorthi2018}.
...
o ogromnej mocy obliczeniowej, zdolnych do przetwarzania danych na gigantyczną skalę, co pozwala na uzyskanie najwyższej jakości generowanych opisów obrazów.
...
\subsubsection{Gemini 2.5 Flash Lite}\label{sss:Gemini}
\noindent
Gemini 2.5 Flash Lite to multimodalny model AI firmy Google zaprojektowany z naciskiem na szybkość i efektywność.
