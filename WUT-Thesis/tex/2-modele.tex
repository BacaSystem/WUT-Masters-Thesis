...
\begin{figure}[!h]
    ...
    \end{tikzpicture}
    \caption{Uproszczona architektura ujednoliconego modelu multimodalnego dla obrazu i tekstu.}
...
Przykładowo kwantyzacja z 32-bitowych liczb zmiennoprzecinkowych (FP32) do 8-bitowych liczb całkowitych (INT8) pozwala na zmniejszenie rozmiaru nawet 4-krotnie oraz 2-krotne
przyspieszenie inferencji przy zachowaniu dokładności w graniach 2\% \cite{tflite_quantization_krishnamoorthi2018}.
