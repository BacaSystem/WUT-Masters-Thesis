...
Każdy model został poddany wielokrotnym iteracjom pomiarowym z fazą rozgrzewką, zapewniając wiarygodność statystyczną zebranych danych.
...
koszty operacyjne oraz jakościowym generowanych opisów, ocenianym za pomocą standardowych algorytmów z dziedziny przetwarzania języka naturalnego.
...
uwzględniających specyficzne wymagania projektowanych aplikacji.
...
taking into account specific requirements of the designed applications.
