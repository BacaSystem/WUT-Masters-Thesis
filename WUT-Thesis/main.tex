...
\engtitle{
    Analysis of the effectiveness of local and cloud AI models \\
    for generating image descriptions in mobile applications
}
...
\input{tex/1-wstep}        
\input{tex/2-literatura}   
\input{tex/3-modele}        
\input{tex/4-app}
\input{tex/5-metodologia}
\input{tex/6-wyniki}
